        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="workflow-step {{ in_array($vente->statut, ['fiche_envoyee', 'visite_planifiee', 'offre_acceptee', 'terminee']) ? 'completed' : ($vente->statut == 'demande_client' ? 'active' : '') }}">
                    ...
                    <div class="workflow-step {{ in_array($vente->statut, ['visite_planifiee', 'offre_acceptee', 'terminee']) ? 'completed' : ($vente->statut == 'fiche_envoyee' ? 'active' : '') }}">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                <h6 class="mb-2">
                    ...
                    <div class="workflow-step {{ in_array($vente->statut, ['offre_acceptee', 'terminee']) ? 'completed' : ($vente->statut == 'visite_planifiee' ? 'active' : '') }}">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                <h6 class="mb-2">
                    ...
                    <div class="workflow-step {{ $vente->statut == 'terminee' ? 'completed' : ($vente->statut == 'offre_acceptee' ? 'active' : '') }}">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                <h6 class="mb-2">
                                ...
                                @if(in_array($vente->statut, ['offre_acceptee', 'terminee']))
                                    <div class="info-card mt-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end"><strong>{{ number_format($vente->montantTotalAPayer(), 0, ',', ' ') }} FCFA</strong></div>
                                        </div>
                                    </div>
                                    @if($vente->statut == 'offre_acceptee')
                                        ...
                                        <div class="mt-3 p-3 bg-light rounded">
                                            ...
                                            <div class="d-flex justify-content-between mb-3">
                                                <span><strong>Payé:</strong> <span class="text-success">{{ number_format($vente->montantTotalPaye(), 0, ',', ' ') }} FCFA</span></span>
                                                <span><strong>Reste:</strong> <span class="text-danger">{{ number_format($vente->resteAPayer(), 0, ',', ' ') }} FCFA</span></span>
                                            </div>

                                            <!-- Info Commission -->
                                            @if($vente->commission_agence)
                                            <div class="alert alert-success mb-3">
                                                <h6 class="alert-heading mb-2"><i class="ri-percent-line me-1"></i>Commission d'agence configurée</h6>
                                                <div class="row">
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-6 text-end">
                                                        ...
                                                        <span class="fs-5 text-success">{{ number_format($vente->calculerCommission(), 0, ',', ' ') }} FCFA</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 text-center">
                                                        ...
                                                        <strong class="text-success">Commission perçue (vente finalisée)</strong>
                                                    </div>
                                                </div>
                                                @else
                                                <hr class="my-2">
                                                <div class="row">
                                                    <div class="col-12 text-center text-muted">
                                                        <i class="ri-time-line me-1"></i>
                                                        <small>Commission sera perçue à la finalisation de la vente</small>
                                                    </div>
                                                </div>
                                                @endif
                                            </div>
                                            ...
                                            <h6 class="mb-2"><i class="ri-history-line me-1"></i>Historique des paiements ({{ $vente->paiements->count() }})</h6>
                                                    ...
                                                    <table class="table table-sm table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    <strong>{{ number_format($paiement->montant, 0, ',', ' ') }}</strong> FCFA
                                                                </td>
                                                                <td>
                                                                    <small>{{ ucfirst(str_replace('_', ' ', $paiement->methode_paiement)) }}</small>
                                                                    @if($paiement->reference)
                                                                        <br><small class="text-muted">Réf: {{ $paiement->reference }}</small>
                                                                    @endif
                                                                    @if($paiement->notes)
                                                                        <br><small class="text-muted">{{ $paiement->notes }}</small>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                        ...
                                                        <tfoot class="table-light">
                                                            <tr>
                                                                ...
                                                                <td class="text-end"><strong class="text-success">{{ number_format($vente->montantTotalPaye(), 0, ',', ' ') }}</strong> FCFA</td>
                                                                <td></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                        ...
                                        <button class="btn btn-sm btn-success w-100" data-bs-toggle="modal" data-bs-target="#validerPaiementModal">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                ...
                                <div class="card bg-success bg-opacity-10 border-success mt-3">
                                    <div class="card-body">
                                        <h6 class="text-success mb-3"><i class="ri-money-dollar-circle-line me-1"></i>Récapitulatif financier</h6>
                                        <div class="row mb-2">
                                            <div class="col-7">Montant total perçu:</div>
                                            <div class="col-5 text-end"><strong>{{ number_format($vente->montantTotalPaye(), 0, ',', ' ') }} FCFA</strong></div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-7">Nombre de paiements:</div>
                                            <div class="col-5 text-end"><strong>{{ $vente->paiements->count() }}</strong></div>
                                        </div>
                                        <div class="row mb-2">
                                            <div class="col-7">Commission totale perçue:</div>
                                            <div class="col-5 text-end"><strong class="text-success">{{ number_format($vente->totalCommissionsPercues(), 0, ',', ' ') }} FCFA</strong></div>
                                        </div>
                                        @if($vente->date_finalisation)
                                        <div class="row">
                                            <div class="col-7">Date de finalisation:</div>
                                            <div class="col-5 text-end">{{ $vente->date_finalisation->format('d/m/Y') }}</div>
                                        </div>
                                        @endif
                                    </div>
                                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3 border-success">
                <div class="card-header bg-success bg-opacity-10">
                    <h5 class="card-title mb-0 text-success"><i class="ri-money-dollar-circle-line me-2"></i>Commission d'agence</h5>
                </div>
                <div class="card-body">
                    <div class="info-card">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fs-5 text-success fw-bold">{{ number_format($vente->calculerCommission(), 0, ',', ' ') }} FCFA</span>
                        </div>
                        ...
                        <div class="alert alert-info mb-0">
                            ...
                            <small>La commission sera perçue lors de la finalisation de la vente (paiement complet).</small>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <a href="{{ route('backend.ventes.fiche', $vente) }}" class="btn btn-success btn-sm w-100 mb-2" target="_blank">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-6 text-end text-success">{{ number_format($vente->montantTotalPaye(), 0, ',', ' ') }} FCFA</div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-end"><strong class="text-danger">{{ number_format($vente->resteAPayer(), 0, ',', ' ') }} FCFA</strong></div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-warning mb-3">
                            ...
                            <small>Cette configuration sera faite une seule fois et s'appliquera sur le montant total de la vente.</small>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="commission_agence" id="commission_agence_modal" class="form-control" required step="0.01" min="0" placeholder="Ex: 5 ou 500000">
                                    </div>
                                </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type_montant" id="paiement_partiel" value="partiel" checked>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type_montant" id="paiement_total" value="total">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="montant_display" id="montant_paiement" class="form-control" 
                                   placeholder="Ex: 1 000 000 ou 500 000"
                                   data-reste="{{ $vente->resteAPayer() }}">
                            <input type="hidden" name="montant" id="montant_hidden" required>
                            <small class="text-muted" id="montant_hint">Saisissez le montant à payer (vous pouvez mettre des espaces)</small>
                        </div>
                        <div class="mb-3">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculerCommissionModal() {
            ...
            if (commissionValue > 0) {
                commissionMontant.textContent = commissionCalculee.toLocaleString('fr-FR', {minimumFractionDigits: 0, maximumFractionDigits: 0});
            ...
            montantPaiement.addEventListener('blur', function() {
                if (this.value) {
                    ...
                    if (numeric > resteAPayer) {
                        montantHint.textContent = '⚠️ Le montant dépasse le reste à payer (' + resteAPayer.toLocaleString('fr-FR', {minimumFractionDigits: 0, maximumFractionDigits: 0}) + ' FCFA)';
                        ...
                        if (!paiementTotal || !paiementTotal.checked) {
                            montantHint.textContent = 'Saisissez le montant à payer (max: ' + resteAPayer.toLocaleString('fr-FR', {minimumFractionDigits: 0, maximumFractionDigits: 0}) + ' FCFA)';
        ...
        function updateMontantPaiement() {
            ...
            if (paiementTotal && paiementTotal.checked) {
                ...
                montantHint.textContent = 'Paiement du solde total : ' + resteAPayer.toLocaleString('fr-FR', {minimumFractionDigits: 0, maximumFractionDigits: 0}) + ' FCFA';
