                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            @foreach($roles as $role)
                                ...
                                @endphp
                                <div class="col-md-3">
                                    <div class="card role-card text-center p-3 {{ $isSelected ? 'selected' : '' }}" data-role="{{ $role->id }}">
                                        <div class="card-body">
                                            @switch($role->name)
                                                @case('locataire')
                                    ...
                                    @foreach($user->getMedia('piece_identite') as $media)
                                        <div class="document-item">
                                            @if(str_contains($media->mime_type, 'image'))
                                                <img src="{{ $media->getUrl() }}" class="document-preview" alt="Pièce d'identité">
                                            @else
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach($user->getMedia('documents') as $media)
                                        <div class="document-item">
                                            @if(str_contains($media->mime_type, 'image'))
                                                <img src="{{ $media->getUrl() }}" class="document-preview" alt="Document">
                                            @else
                                                <div class="document-preview d-flex align-items-center justify-content-center bg-light">
