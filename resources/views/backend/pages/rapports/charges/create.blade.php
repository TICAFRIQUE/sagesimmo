...
@section('content')
    @component('backend.components.breadcrumb')
        @slot('li_1')
            <a href="{{ route('backend.charges.index') }}">Charges</a>
        @endslot
        @slot('title')
            Créer une charge
        @endslot
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" action="{{ route('backend.charges.store') }}" method="POST" novalidate>
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="annonce_id" id="annonce_id"
                                    class="form-select @error('annonce_id') is-invalid @enderror" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="type_charge" id="type_charge"
                                    class="form-select @error('type_charge') is-invalid @enderror" required>
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="montant" id="montant"
                                        class="form-control @error('montant') is-invalid @enderror" step="0.01"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="date_charge" id="date_charge"
