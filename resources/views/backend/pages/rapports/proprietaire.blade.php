...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center no-print">
                                            ...
                                            <button type="button"
                                                ...
                                                onclick="openChargeModal({{ $bien['bien']->id ?? 0 }}, '{{ addslashes($bien['bien']->titre ?? '') }}')"
                                                title="Ajouter une charge">
                                                <i class="ri-money-dollar-circle-line"></i> Charge
                                            </button>
                                        </td>
                                    </tr>
    ...
    {{-- Modal Créer une Charge depuis le rapport propriétaire --}}
    <div class="modal fade no-print" id="chargeRapportModal" tabindex="-1" aria-labelledby="chargeRapportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('backend.charges.store') }}" method="POST">
                    ...
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title" id="chargeRapportModalLabel">
    ...
    <script>
        ...
        function openChargeModal(annonceId, titreBien) {
            ...
            var modal = new bootstrap.Modal(document.getElementById('chargeRapportModal'));
            modal.show();
        }
    </script>
@endsection
